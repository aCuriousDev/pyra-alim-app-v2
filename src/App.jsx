        ...
        {showResults && (
          <>
            ...
            >
              ...
              <p>
                Cliquez sur les catégories ci-dessous pour explorer votre
                pyramide alimentaire en détail.
              </p>
              <div
            ...
            <div className="ref-pyramide-container">
              <div className="ref-pyramid-explain">
                ...
                <br />
                <span className="accent">En vert</span> sont indiqués les
                aliments que vous consommez à la bonne fréquence et{' '}
                <span className="accent-red">en rouge</span> les aliments dont
                la fréquence de consommation pourraient être améliorée.
              </div>
              <div>
